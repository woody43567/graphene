...
const TOOLS = [
    ...
    {
        name: "read",
        description: "Read the context graph. No arguments returns the full index (all node names, types, summaries). With a name argument, returns the node with edges, dependents, and observations (truncated to snippets by default, paginated in batches of 5). Use full=true for untruncated content, obs_offset/obs_limit for pagination.",
        inputSchema: {
            type: "object",
            properties: {
                name: {
